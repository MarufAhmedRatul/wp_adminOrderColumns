...
Chalan - PDF Invoice & Packing Slip for WooCommerce generate PDF invoice automatically and send it to your customers by attaching it with the order email based on the configured order status.

Chalan includes a basic template with some additional templates, which you can modify at any time. It also includes the bulk invoice and packing slip download, invoice number, custom date format, localization, logo resize, etc.  The process of creating and printing invoices is easy with Chalan.
...
Chalan – PDF Invoice & Packing Slip for WooCommerce by WebAppick allows you to create an invoice in PDF format. The plugin automatically attaches the pdf invoice with the order confirmation emails and instantly sends it to the customer whenever the order status changes.
...
Chalan - PDF invoice plugin includes a vast number of customization options according to customer requirements. For example, Users can customize invoice numbers, order numbers, product title, customer note, shipping and billing address, etc.
...
Chalan is a unique PDF invoice plugin for WooCommerce that allows users to interchange between multiple available templates. The customizable invoice templates of this plugin ensure a better user experience for the clients.
...
Order total shows the cost after calculating the vat, tax, and extra fee of a product. Chalan is compatible with numerous third-party “Extra Fee” plugins. You can easily customize the order total using the filter hook available in this plugin.
...
Chalan PDF invoice plugin is capable of displaying currencies of different countries. The plugin also includes codes and symbols for different country-related currencies. It allows users from other countries to use this plugin and generate an invoice according to their required currency option.
...
The Chalan plugin's pro version offers a fantastic feature that allows you to include the product image. Including the product image on the invoice makes it look more professional. Customers easily understand the invoice at a glimpse when they can see the product image along with it.

= 💎 Booking Product (Pro) 💎 =

Chalan PDF invoice plugin is compatible with numerous booking plugins. When a customer is booking any service type, the plugin collects the booking information and displays it in the invoice.
...
Chalan WooCommerce invoice Plugin is compatible with various WooCommerce subscription plugin emails. You can attach an invoice for recurring payments with these plugins. Since Chalan supports Subscription plugin emails, you don't need to overthink invoicing for recurring payments.
...
With the Chalan PDF invoice plugin, you can add a “PAID” stamp on the Invoice after the payment is processed. With a paid stamp, it becomes easy to understand that the bill is already paid. The “PAID” stamp is shown on the Invoice only if the customer completes the payment.
...
With the Chalan WooCoomerce invoice plugin, you can customize your invoice by including a Watermark. You can create and customize a watermark according to your preference. You can add a watermark on your invoice's background, which saves the PDF invoice's confidentiality.
...
Chalan PDF invoice plugin gives you the privilege to select fonts for your invoice according to your style. There is a font section on the plugin’s Settings page. Users can also use a font that is not available on the plugin’s settings option. They can download a font from the internet, upload it, and apply it.
...
1. Go to "Chalan" menu and configure your settings
